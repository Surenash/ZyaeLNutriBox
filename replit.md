...
**Health Goals Categories**: Premium meal plan cards with DietPlanCard-style layout featuring images, pricing (original/discounted), star ratings, review counts, optional badges ("Most Popular", "High Protein", "Doctor Approved"), and "Subscribe Now" buttons. Grid layout: grid-cols-1 md:grid-cols-2 lg:grid-cols-4. Plans include Weight Loss (₹15,000/month, 4.9★), Muscle Gain (₹17,000/month, 4.8★), Balanced Nutrition (₹13,500/month, 4.7★), and Diabetic Friendly (₹14,500/month, 4.9★).
