  ...
  const renderClient = ({ item }: { item: Client }) => (
    <Card style={styles.clientCard}>
      ...
      <View style={styles.clientActions}>
        <Button
          title="View Details"
          onPress={() => console.log('View client details:', item.id)}
          size="small"
          variant="outline"
        />
        <Button
          title="Schedule Call"
          onPress={() => console.log('Schedule consultation:', item.id)}
          size="small"
          variant="primary"
        />
      </View>
  ...
  const renderConsultation = ({ item }: { item: Consultation }) => (
    <Card style={styles.consultationCard}>
      ...
      <View style={styles.consultationActions}>
        <Button
          title="View Details"
          onPress={() => console.log('View consultation:', item.id)}
          size="small"
          variant="outline"
        />
        {item.status === 'scheduled' && (
          <Button
            title="Start Call"
            onPress={() => console.log('Start consultation:', item.id)}
            size="small"
            variant="primary"
          />
        )}
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>Welcome back, Dr. {user?.name}</Text>
          ...
          <View>
            ...
            <View style={styles.quickActions}>
              ...
              <Button
                ...
                onPress={() => console.log('Create meal plan')}
                variant="outline"
              />
              <Button
                title="View Reports"
